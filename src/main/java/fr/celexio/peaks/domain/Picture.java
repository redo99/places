...
public class Picture implements Serializable {
    ...
    @Lob
    @Column(name = "peaks_file", nullable = false)
    private byte[] file;

    @Column(name = "peaks_file_content_type", nullable = false)
    ...
    public Picture fileContentType(String fileContentType) {
