...
import fr.celexio.peaks.config.audit.AuditEventConverter;
import fr.celexio.peaks.domain.PersistentAuditEvent;
...
import static fr.celexio.peaks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
