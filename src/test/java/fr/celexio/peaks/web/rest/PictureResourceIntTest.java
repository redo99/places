...
public class PictureResourceIntTest {
     ...
     *
     * @see fr.celexio.peaks.repository.search.PictureSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createPicture() throws Exception {
        ...
        assertThat(testPicture.getFileContentType()).isEqualTo(DEFAULT_FILE_CONTENT_TYPE);
    ...
    public void updatePicture() throws Exception {
        ...
        assertThat(testPicture.getFileContentType()).isEqualTo(UPDATED_FILE_CONTENT_TYPE);
